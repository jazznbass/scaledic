...
This is a short description on how to use the scaledic package. The code eyamples in this package make use of the pipe operator `%>%` (see the `magrittr` package).  
Once you are used to the pipe operator, it makes code easier to understand. Basically, it is just a shortcut:
