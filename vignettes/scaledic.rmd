...
dic_itrf[2:4, c("item_name", "item_label", "scale", "scale_label", "subscale", 
                "subscale_label", "values", "value_labels", "missing", "type")]|> 
...
" |> 
  wmisc::nice_table(caption = "Basic columns of a dictionary file", cols_align = list(left = 2:3))
...
```{r}
#| echo: false
list_scales(dat, "subscale_label", "subscale_2_label") |> wmisc::nice_table(cols_align = list(left = 2))
```
